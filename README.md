...
- **`streamlit_app.py`**: The file you point Streamlit to for the web version.
- **`run_scraper.bat`**: Double-click this to run the local dashboard on Windows.
- **`run_streamlit_live.bat`**: Double-click this to test the web version on your own machine.
- **`requirements.txt`**: Essential ingredients list for the cloud.
